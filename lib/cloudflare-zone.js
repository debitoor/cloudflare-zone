...
let getCloudflareZoneDnsRecords = (() => {
	var _ref3 = _asyncToGenerator(function* (cloudflareZoneId, auth) {
	...
	return function getCloudflareZoneDnsRecords(_x4, _x5) {
		return _ref3.apply(this, arguments);
	};
})();

let createCloudflareZoneDnsRecord = (() => {
	var _ref4 = _asyncToGenerator(function* (cloudflareZoneId, parameters, auth) {
	...
	return function createCloudflareZoneDnsRecord(_x6, _x7, _x8) {
		return _ref4.apply(this, arguments);
	};
})();

let updateCloudflareZoneDnsRecord = (() => {
	var _ref5 = _asyncToGenerator(function* (cloudflareZoneId, dnsRecordId, parameters, auth) {
	...
	return function updateCloudflareZoneDnsRecord(_x9, _x10, _x11, _x12) {
		return _ref5.apply(this, arguments);
	};
})();

let deleteCloudflareZoneDnsRecord = (() => {
	var _ref6 = _asyncToGenerator(function* (cloudflareZoneId, dnsRecordId, auth) {
	...
	return function deleteCloudflareZoneDnsRecord(_x13, _x14, _x15) {
...
let main = exports.main = (() => {
	var _ref7 = _asyncToGenerator(function* ({ file, authEmail, authKey }) {
		try {
			const auth = {
				email: authEmail,
				key: authKey
